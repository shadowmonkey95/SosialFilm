...
//                    $('#add_comment').closest("div.display-comment + *").find("p").append('afsasd');
//                    $('#add_comment').closest('.display-comment');
//                    console.log(result['comment']['content']);

                    $('#display_comments').append(result);
                    console.log(result);
                }
            });
//            $("#me").closest("h3 + *").prev().find('span b');
//            $('#add_comment').prev('.display-comment').css( "background-color", "red" );
        });
    });
//    https://stackoverflow.com/questions/7018337/find-closest-previous-element-jquery
</script>
<script>
